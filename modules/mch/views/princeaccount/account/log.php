            ...
            <ul class="nav nav-tabs status">
                <li class="nav-item">
                    <a class="status-item nav-link <?= $type == -1 ? 'active' : '' ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/princeaccount/account/log'])) ?>">全部</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $type == 1 ? 'active' : '' ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/princeaccount/account/log'], ['type' => 1])) ?>">收入</a>
                </li>
                <li class="nav-item">
                    <a class="status-item nav-link <?= $type == 2 ? 'active' : '' ?>"
                       href="<?= $urlManager->createUrl(array_merge(['mch/princeaccount/account/log'], ['type' => 2])) ?>">支出</a>
                </li>
            </ul>
        </div>
