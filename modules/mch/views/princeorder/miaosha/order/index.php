                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary del"
                                   href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/delete-all']) ?>"
                                ...
                                <?php if ($order_item['is_delete'] == 0): ?>
                                    <span class="mb-2">
                                        <a class="btn btn-sm btn-info apply-status-btn"
                                           href="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/apply-delete-status', 'id' => $order_item['id'], 'status' => 1]) ?>">同意请求</a>
                                    </span>
                                    <span class="mb-2">
                                        <a class="btn btn-sm btn-danger refuse apply-status-btn"
                                           href="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/apply-delete-status', 'id' => $order_item['id'], 'status' => 0]) ?>">拒绝请求</a>
                                    </span>
                                <?php endif; ?>
                            <?php endif; ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <?php endif; ?>
                            ...
                            <?php if ($order_item['is_recycle'] == 1) : ?>
                                <div>
                                    <a class="btn btn-sm btn-primary mt-2 del" href="javascript:"
                                       data-url="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/recycle', 'order_id' => $order_item['id'], 'is_recycle' => 0]) ?>"
                                       data-content="是否移出回收站">移出回收站</a>
                                </div>
                            <?php else : ?>
                                <div>
                                    <a class="btn btn-sm btn-danger mt-2 del" href="javascript:"
                                       data-url="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/recycle', 'order_id' => $order_item['id'], 'is_recycle' => 1]) ?>"
                            ...
                            <?php if ($order_item['is_recycle'] == 1) : ?>
                                <div>
                                    <a class="btn btn-sm btn-danger mt-2 del" href="javascript:"
                                       data-url="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/delete', 'order_id' => $order_item['id']]) ?>"
                            ...
                            <?php if ($order_item['pay_type'] == 2 && $order_item['is_send'] == 1 && $order_item['is_confirm'] != 1): ?>
                                <div>
                                    <a href="javascript:" class="btn btn-sm btn-primary mt-2 del"
                                       data-url="<?= $urlManager->createUrl(['mch/princeorder/miaosha/order/confirm', 'order_id' => $order_item['id']]) ?>"
...
<script>
    ...
    $(document).on("click", ".send-confirm-btn", function () {
        ...
        console.log(error);
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/princeorder/miaosha/order/send'])?>",
            type: "post",
...
<script>
    ...
    $(document).on('click', '.print', function () {
        ...
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/princeorder/miaosha/order/print'])?>",
            type: 'get',
            dataType: 'json',
            data: {
                id: id,
...
<script>
    ...
    $(document).on('click', '.change-price', function () {
        ...
        var url = "<?=$urlManager->createUrl(['mch/princeorder/miaosha/order/update-price'])?>"
        $.ajax({
            url: url,
            type: 'get',
            dataType: 'json',
