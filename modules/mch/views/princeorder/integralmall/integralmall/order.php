                        ...
                        <div class="mr-4">
                            <div class="form-group">
                                ...
                                <a class="btn btn-secondary del"
                                   href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/delete-all']) ?>"
                    ...
                    <tr>
                        ...
                        <td class="order-tab-5">
                            <?php if ($order_item['apply_delete'] == 1) : ?>
                                <div class="mb-2">
                                    <a class="btn btn-sm btn-info apply-status-btn"
                                       href="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/apply-delete-status', 'id' => $order_item['id'], 'status' => 1]) ?>">同意请求</a>
                                </div>
                                <div class="mb-2">
                                    <a class="btn btn-sm btn-danger refuse apply-status-btn"
                                       href="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/apply-delete-status', 'id' => $order_item['id'], 'status' => 0]) ?>">拒绝请求</a>
                                </div>
                            <?php endif; ?>
                            ...
                            <?php endif; ?>
                               ...
                               href="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/detail', 'order_id' => $order_item['id']]) ?>">详情</a>
                            ...
                            <div>
                                <a href="javascript:" class="btn btn-sm btn-primary mt-2 del"
                                   data-url="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/confirm', 'order_id' => $order_item['id']]) ?>"
                            ...
                            <?php if ($order_item['is_recycle'] == 1) : ?>
                                <div>
                                   ...
                                   data-url="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/recycle', 'order_id' => $order_item['id'], 'is_recycle' => 0]) ?>"
                                   data-content="是否移出回收站">移出回收站</a>
                                </div>
                                <div>
                                <a class="btn btn-sm btn-danger del mt-2" href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/delete', 'order_id' => $order_item['id']]) ?>"
                                       data-content="是否删除">删除订单</a>
                                </div>
                            <?php else : ?>
                                <div>
                                    <a class="btn btn-sm btn-danger del mt-2" href="javascript:"
                                   data-url="<?= $urlManager->createUrl(['mch/princeorder/integralmall/integralmall/recycle', 'order_id' => $order_item['id'], 'is_recycle' => 1]) ?>"
...
<script>
    ...
    $(document).on("click", ".send-confirm-btn", function () {
        ...
        error.hide();
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/princeorder/integralmall/integralmall/send'])?>",
            type: "post",
...
<script>
    ...
    $(document).on('click', '.print', function () {
        ...
        $.ajax({
            url: "<?=$urlManager->createUrl(['mch/princeorder/integralmall/integralmall/print'])?>",
            type: 'get',
            dataType: 'json',
            data: {
                id: id,
