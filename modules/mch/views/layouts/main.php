...
<head>
    ...
    <link href="<?= Yii::$app->request->baseUrl ?>/statics/mch/css/common.v2.css?version=<?= $version ?>"
          rel="stylesheet">
    <link href="<?= Yii::$app->request->baseUrl ?>/statics/mch/css/header.css" rel="stylesheet">
    ...
    <script src="<?= Yii::$app->request->baseUrl ?>/statics/mch/js/jquery.min.js"></script>
        <script src="<?= Yii::$app->request->baseUrl ?>/statics/js/jquery-2.1.1.min.js" type="text/javascript"></script>
...
<div class="main">
  ...
  <div class="ny-header link-undecorated" style="z-index: 1000">
        ...
        <div class="header-main text-right">
            <div class="pull-left header-left">
                <a href="<?= $urlManager->createUrl(['mch/default/index']) ?>" class="header-link header-link-overview">
                    总览
                </a>
            </div>
            ...
            <div class="pull-right">
                <div class="header-link header-link-help">
                    <a href="/help/public/index.php" style="color: #fff;">帮助文档</a>
                </div>
                <div class="message header-link header-link-message">
                    <a href="<?= $urlManager->createUrl(['mch/store/order-message']) ?>" style="color: #fff;">消息提醒</a>
                    <span class="header-message-count totalNum" hidden>2</span>
                  <div class="dropdown-menu dropdown-menu-right message-list" hidden></div>
                </div>
                <div class="header-link header-link-user header-link-drop">
                    <span class="header-username" id="helloUserName">
                    ...
                    <ul class="header-drop-list header-user-links">
                        <li>
                            <a href="javascript:void(0);" style="text-decoration: none" class="dropdown-item">
                                <?php if (Yii::$app->user->isGuest == false): ?>
                                    管理员:&nbsp;<?= Yii::$app->user->identity->nickname ?>
                                <?php elseif (Yii::$app->admin->isGuest == false): ?>
                                    管理员:&nbsp;<?= Yii::$app->admin->identity->username ?>
                        ...
                        <li class="header-finance-last-link">
                            <?php if (Yii::$app->user->isGuest == false): ?>
