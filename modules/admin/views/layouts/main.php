...
<nav class="navbar navbar-expand-md  navbar-light bg-white" style="border-bottom: 1px solid #e3e3e3">
    <div class="container">
       <a class="navbar-brand p-0"  href="/web/index.php?r=admin%2Fuser%2Fme">
            <img src="<?= $logo ?>" style="height: 45px;display: inline-block">
        </a>
                        ...
                        <?php if ($item['show']) : ?>
                            <li class="nav-item nav-group">
                                ...
                                <?php foreach ($item['children'] as $i) : ?>
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <?php if (Yii::$app->admin->identity->username == 'admin'):?>
                                                <?php if ($i['name'] == '我的账户'): ?>
                                                    <a class="nav-link <?= $currentRoute == 'admin/default/index' ? 'active' : '' ?>"
                                                       href="/web/index.php?r=admin%2Fdefault%2Findex">
